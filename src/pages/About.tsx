          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden group">
              <div className="aspect-w-3 aspect-h-4 relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                  <div className="p-4 text-white">
                    <h3 className="text-xl font-medium">Robert Thompson, LCPC</h3>
                    <p className="text-white/80">Mental Health Counselor</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <p className="mb-4">
                  Robert specializes in anxiety disorders, depression, and stress management. He utilizes a blend of 
                  cognitive-behavioral therapy, mindfulness, and solution-focused techniques.
                </p>
                <p className="text-harmony-green font-medium">Education: MA in Counseling, Loyola University</p>
              </div>
            </div>
          </div>
        </div>
